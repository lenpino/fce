 ...
 */
public class ListResult extends java.util.Vector implements java.util.Enumeration {
 ...
 */
public ListResult(int initialCapacity) {
 ...
 */
public ListResult(int initialCapacity, int capacityIncrement) {
 ...
 */
public ListResult(java.util.Collection c) {
	super(c);
}
	/**
